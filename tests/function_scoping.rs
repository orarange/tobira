...
fn function_scoping_patterns() {
    let cases: &[(&str, &str)] = &[
        ...
        (
            "fn decl referenced from other switch case",
            r#"
        ...
        (
            "nested fn decl referenced in sibling fn",
            r#"
        ...
        (
            "var assigned then read as implicit (strict off) seq",
            r#"
        ...
        (
            "fn expr name in own scope (named fn expr recursion)",
            r#"
        ...
        (
            "fn decl in try block used after",
            r#"
        ...
        (
            "conditional fn decl both branches",
            r#"
        ...
        (
            "fn decl shadowing outer in block",
            r#"
        ...
        (
            "IIFE bang with named fn decl inside",
            r#"
            var out;
        ...
        (
            "named FE name used in nested closure",
            r#"
        ...
        (
            "named FE name used in nested arrow",
            r#"
        ...
        (
            "named FE referenced as property/value not call",
            r#"
        ...
        (
            "var fn-expr deep recursion (minified style)",
            r#"
    ...
    for (name, src) in cases {
        let full =
            format!("function assert(c){{ if(!c) throw new Error('assert failed: '); }}\n{src}");
