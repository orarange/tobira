...
fn probe_hoisting() {
    let cases: &[(&str, &str)] = &[
        (
            "var hoists from block to function scope",
            r#"
        ...
        (
            "function decl hoisted (call before)",
            r#"
        ...
        (
            "function decl in block hoists (Annex B)",
            r#"
        ...
        (
            "function decl in if-block used after",
            r#"
        ...
        (
            "var hoist self-reference undefined then assigned",
            r#"
        ...
        (
            "conditional function expr assigned to var in block",
            r#"
        ...
        (
            "nested block var across siblings",
            r#"
        ...
        (
            "hoist var declared after return-ish use in closure",
            r#"
