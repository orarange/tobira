...
fn var_hoisting_from_nested_blocks() {
    let cases: &[(&str, &str)] = &[
        (
            "hoisted fn refs var in later nested block",
            r#"
        ...
        (
            "hoisted fn refs var in later if-block",
            r#"
        ...
        (
            "hoisted fn refs var declared after (top level of fn)",
            r#"
        ...
        (
            "fn expr in var refs var in later block",
            r#"
        ...
        (
            "hoisted fn refs var in later for-init",
            r#"
        ...
        (
            "hoisted fn refs var deep in nested blocks",
            r#"
        ...
        (
            "hoisted fn refs var in switch case",
            r#"
