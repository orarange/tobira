    ...
    fn falls_back_when_document_is_empty() {
        let page = BrowserPage {
            ...
            styled_document: StyledNode::Text(crate::css::StyledText {
                text: String::new(),
                style: std::sync::Arc::new(crate::css::ComputedStyle { break_long_words: false, baseline_shift: 0, table_role: crate::css::TableRole::None, flow_root: false, table_cellpadding: None,
